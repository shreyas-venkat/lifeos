/**
 * Sleep insights -- correlates sleep with supplements and activity
 * for the /sleep/insights endpoint.
 *
 * Ported from src/api/routes/sleep.ts (insights endpoint only)
 */
...
export async function getSleepInsights(): Promise<Insight[]> {
